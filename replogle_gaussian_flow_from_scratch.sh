...
opt m, 
 imization.scheduler.min_ratio=0.01
...
run_name=from_scratch_replogle_gaussian_flow_delta
lightning.logger.project=perturb_flow_gaussian_delta
lightning.logger.name=v1_ckpt
sampling_eval.enabled=true
sampling_eval.flow_steps=6
sampling_eval.guidance_strength=0.25
"
